...
public enum NameJoueurFemme {

	Albot("Albot", "Rado", "Moldave", "11/11/1989", "Chisinau", "Droitier", "Jimmy Oganezov", 175, 70,"nomCourant1"),
	...
	Alves("Alves", "Thiago", "Brésilien", "22/05/1982", "São José do Rio Preto", "Droitier", "Carlos Albano", 178, 75,"nomCourant2"),
	...
	Djokovic("Djokovic","Novak","Serbe","22/05/1987","Belgrade","Droitier","Marian Vajda",188,79,"nomCourant3"),
	...
	Novak("Novak","Dennis","Autrichien","28/08/1993","Wiener Neustadt","Droitier","Gunter Bresnik et Wolfgang Thiem",183,80,"nomCourant4"),
	...
	Jonathan("Dasnières de Veigy","Jonathan","Française", "05/01/1987", "Nîmes","Gaucher","Thierry Ascione",174,70,"nomCourant5"),
	...
	WangTak("Wang","tak khunn","Française","12/10/1991","Paris","Droitier","Jean-Alexis Boulesios",175,66,"nomCourant6"),
	...
	Verdasco("Verdasco","Fernando","Espagnol","15/11/1983","Madrid","Gaucher","Sergio Perez",188,81,"nomCourant7"),
	...
	Tsonga("Tsonga","Jo-Wilfried","Française","17/04/1985","Le Mans","Droitier","Thierry Ascione et Sergi Brugera",188,90,"nomCourant9"),
	...
	Thiem("Thiem","Dominic","Autrichien","03/09/1993","Wiener Neustadt","Droitier","Gunter Bresnik",185,82,"nomCourant8"),
	...
	Soeda("Soeda","Go","Japonais","05/09/1984","Fujisawa","Droitier","Davide Sanguinetti",178,73,"nomCourant10"),
	...
	NameJoueurFemme(String nom, String prenom, String nationalite, String dateNaissance, String lieuNaissance,
	...
	NameJoueurFemme(String nom, String prenom, String nationalite, String dateNaissance, String lieuNaissance,
			String main, String entraineur, int poids, int taille, String nomCourant) {
		this.nom = nom;
		this.prenom = prenom;
		this.nationalite = nationalite;
		this.dateNaissance = dateNaissance;
	...
	public static NameJoueurFemme getRandomJoueurFemme() {
